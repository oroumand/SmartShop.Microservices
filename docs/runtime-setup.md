...
این سند یک runbook فنی برای اجرای SmartShop روی ماشینی است که پیش‌نیازهای لازم را دارد. هدف این راهنما این است که ترتیب آماده‌سازی سرویس‌ها، تنظیمات، اجرای API، تست دستی با Scalar، تست AiSearch و اجرای k6 روشن و قابل تکرار باشد.
